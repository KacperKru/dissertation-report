...
% -----------------------------------------------------------------------------
\title{Music player designed for people with dementia}
\author{Kacper Kruszewski}
\logo{images/cardiff_logo}
% Degree
...
\copyrightholder{Kacper Kruszewski}
\licenseyear{2026}
...
\maketitle{%
  ...
  % your own abstract.
  Dementia encompasses a variety of conditions that degrade cognitive abilities, including problem-solving and memory.
  This, in turn, makes everyday tasks, such as operating a music player, more difficult in comparison to an able-bodied
  person. This project aims to tackle this by simplifying operation of a music player for the patient but still allowing
  more complex operations to occur remotely.

  This project utilises \gls{ssh} as its remote solution, providing Python files to interface with the device. 
  Operations include: Switching Playlist (with shuffle functionality), Pausing and Skipping. The device also contains 
  \gls{nfc} capabilities to switch playlists.

  Conducting a combination of integration testing and unit-tests, all functions and modules passed, testing various
  input types including erroneous, valid and null. This project provides a functional prototype of a solution of an 
  accessible media player with remote solution with plenty of room for expansion, including streamlining the setup process
  using Access Point capabilities and including more complex commands for remote management.
}
...
\dedication{%
  To my family and friends, who have continued to support me throughout my degree.%
}

\chapter{Acknowledgements}
% Replace with your acknowledgements. Here you can also acknowledge any contributions from other
% parties to the work.
I would like to thank my supervisor Stuart M Allen, ENRICH Cymru and the Cardiff University COMSC Technical Team 
for their continued support and contributions to the project.
...
Code produced for this dissertation is available from the following GitHub repository:
\url{https://github.com/KacperKru/CM3203-Project}.
